...
export default function GalleryCard(props: TGalleryCardProps) {
  return (
    <Card className="group relative h-[15vh] w-[50rem] cursor-pointer overflow-hidden border-4 border-background transition-all ease-out md:aspect-[2/3] md:h-[55vh] md:w-[40rem] md:hover:-translate-y-4 md:hover:rotate-2 lg:hover:-translate-y-12">
      <Image
        src={props.image.src}
        alt={props.image.alt}
        fill
